        ...
        <div className="prose prose-lg max-w-none">
          {article.content.map((paragraph, index) => (
            ...
            <p className="text-stone-700 leading-relaxed mb-6 text-lg">
                <a 
                href="https://bpb-us-e1.wpmucdn.com/sites.harvard.edu/dist/6/210/files/2025/06/HarvardUniversity_CDS_2024-2025.pdf" 
                className="text-[#A51C30] hover:underline" 
                target="_blank" 
                rel="noopener noreferrer"
                >
                Harvard Common Data Set (CDS)
                </a>.
            </p>
        </div>
