...
const BlogArticlePage = () => {
  ...
  const article: BlogArticle = {
    ...
    author: {
      name: "Ariel Mason",
      avatar: "/ariel.png",
      bio: "Sources new content and contributors, bringing fresh ideas and perspectives to Flourish."
    },
    image: "/barnardName.png",
    tags: ["Barnard College", "CDS", "T20", "Admissions"],
    content: [
        ...
        <div className="prose prose-lg max-w-none">
          {article.content.map((paragraph, index) => (
            ...
            <p className="text-stone-700 leading-relaxed mb-6 text-lg">
                <a 
                href="https://barnard.edu/sites/default/files/inline-files/Barnard%20CDS%202024-2025.pdf" 
                className="text-[#002F6C] hover:underline" 
                target="_blank" 
                rel="noopener noreferrer"
                >
                Barnard College Common Data Set (CDS)
                </a>.
            </p>
        </div>
