        ...
        <div className="prose prose-lg max-w-none">
          {article.content.map((paragraph, index) => (
            ...
            <p className="text-stone-700 leading-relaxed mb-6 text-lg">
                <a 
                href="https://www.nyu.edu/content/dam/nyu/institutionalResearch/documents/cds-on-website/2024-2025%20(pdf,%20file%20size%20907KB).pdf" 
                className="text-[#57068C] hover:underline" 
                target="_blank" 
                rel="noopener noreferrer"
                >
                NYU Common Data Set (CDS)
                </a>.
            </p>
        </div>
