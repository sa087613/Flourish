    ...
    <span>
      ...
      <header className="bg-white border-b border-stone-200">
        ...
        <Link 
          ...
          <h1 className="text-4xl font-bold text-stone-900 mb-2" style={{ fontFamily: "'Story Script', serif" }}>Blogs</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredPosts.map((post) => (
            ...
            >
              ...
              {/* Content */}
              <div className="p-6">
                <h2 className="text-xl font-bold text-stone-900 mb-3 group-hover:text-stone-600 transition-colors line-clamp-2" style={{ fontFamily: "'Story Script', serif" }}>
                  {post.title}
                </h2>
