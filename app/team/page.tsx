    ...
    <span>
      ...
      <div className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <h1 className="text-3xl font-bold text-stone-900" style={{ fontFamily: "'Story Script', serif" }}>Our Team</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        */}
        ...
        {/* Team Members Grid */}
        <div>
          <h2 className="text-2xl font-bold text-stone-900 mb-8" style={{ fontFamily: "'Story Script', serif" }}>Team Members</h2>
